...
class FrontRouteCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraflat:route_front {module}';
    ...
    public function handle()
    {
        ...
        $nameSpace = 'App\\Modules\\'.$module->name.'\\Http\\Controllers\\FrontEnd';

        $this->filesystem->put(
            fixPath(base_path('app/Modules/'.$module->name.'/Routes/front.php'))
    ...
    protected function getStub(){
        return __DIR__.'/../../stubs/routes/front.stub';
    }
