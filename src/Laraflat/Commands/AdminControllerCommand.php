...
class AdminControllerCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraflat:admin_controller {module}';
    ...
    public function handle()
    {
        ...
        $this->filesystem->put(
            fixPath(base_path('app/Modules/'.$module->name.'/Http/Controllers/Admin/'.$module->name.'Controller.php'))
    ...
    protected function getStub(){
        return __DIR__.'/../../stubs/controllers/admin.stub';
    }
