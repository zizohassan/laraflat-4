...
use Laraflat\Laraflat\Laraflat\Traits\ModelRelationTrait;
use Laraflat\Laraflat\Laraflat\Traits\ModelTrait;
use Laraflat\Laraflat\Laraflat\Traits\MultiValueHandel;
...
class ModelCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraflat:model {module}';
