...
class AdminFormCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraflat:view_admin_form {module}';
    ...
    public function handle()
    {
        ...
        $path = base_path('app/Modules/'.$module->name.'/Resources/views/admin/'.$smallName);
    ...
    protected function getStub(){
        return __DIR__.'/../../stubs/views/admin/form.stub';
    }
