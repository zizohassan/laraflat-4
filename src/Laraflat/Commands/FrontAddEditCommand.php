...
class FrontAddEditCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laraflat:view_front_add_edit {module}';
     ...
     * @var string
     */
    protected $description = 'We now generate front views file based on module name';
    ...
    protected function getAddStub(){
        return __DIR__.'/../../stubs/views/front/add.stub';
    }
 ...
 */
    ...
    protected function getEditStub(){
        return __DIR__.'/../../stubs/views/front/edit.stub';
    }
