...
use Laraflat\Laraflat\Laraflat\Models\ColumnDetail;
use Laraflat\Laraflat\Laraflat\Models\Module;
use Laraflat\Laraflat\Laraflat\Models\Relation;
use Laraflat\Laraflat\Laraflat\Requests\StepFourRequest;
use Laraflat\Laraflat\Laraflat\Requests\StepOneRequest;
...
class ModuleBuilderController extends Controller
{
    ...
    public function index(Module $modules)
    {
        ...
        */
        ...
        return view('laraflat::admin.generator.index', compact('modules'));
    }
    ...
    public function stepOneView($id = null, Module $module)
    {
        ...
        return view('laraflat::admin.generator.steps.step-one.index', compact(
            'module'
        ));
    }
    ...
    public function stepTwoView($id, Module $module)
    {
       ...
       */
        ...
        return view('laraflat::admin.generator.steps.step-two.index', compact(
            'module',
            'migrationTypes',
            'migrationModifiers'
        ));
    ...
    public function stepThreeView($id, Module $module)
    {
        ...
        return view('laraflat::admin.generator.steps.step-three.index', compact(
            'module',
            'htmlInputType',
            'validationRules'
        ));
    ...
    */
    ...
    public function stepFourView($id, Module $module , Relation $relation)
    {
       ...
       */
        ...
        return view('laraflat::admin.generator.steps.step-four.index', compact(
            'module',
            'relationType',
            'modules',
            'relations',
    ...
    public function stepFiveView($id ,Module $module)
    {
        ...
        return view('laraflat::admin.generator.steps.step-five.index', compact(
            'module',
            'arrays',
            'languages'
        ));
