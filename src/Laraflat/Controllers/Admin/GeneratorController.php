...
class GeneratorController extends Controller
{
    ...
    {
        Artisan::call('laraflat:api_request', ['module' => $module->name]);
    }
    ...
    */
    ...
    {
        Artisan::call('laraflat:api_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:route_front', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:route_api', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:api_resource', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:lang', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:seeder', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:config', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:front_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:admin_request', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_front_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_admin_form', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:front_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:admin_controller', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_front_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_admin_add_edit', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_front_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:view_admin_index', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:migration', ['module' => $module->name]);
    }
   ...
   */
    ...
    {
        Artisan::call('laraflat:provider', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:route_admin', ['module' => $module->name]);
    }
    ...
    {
        Artisan::call('laraflat:model', ['module' => $module->name]);
    }
