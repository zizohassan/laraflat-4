...
<head>
    ...
    <title>@lang('larflat::laraflat.Laraflat')</title>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('modules') }}"><i class="fa fa-circle-o"></i> @lang('laraflat::laraflat.Module Builder')</a></li>
                        <li><a href="{{ route('view-step-one') }}"><i class="fa fa-circle-o"></i> @lang('laraflat::laraflat.Add Module')</a></li>
                    </ul>
                </li>
            </ul>
        </section>
