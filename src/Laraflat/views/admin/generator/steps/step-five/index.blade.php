...
@section('content')
    ...
    <section class="content-header">
        <h1>
            @lang('laraflat::laraflat.Laraflat')
            <small>
                @lang('laraflat::laraflat.Translate') {{ $module->name }}
            </small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li><a class="active">@lang('laraflat::laraflat.Translate')</a></li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="callout callout-info">
            <h4>@lang('laraflat::laraflat.Translate') !</h4>
            <p>@lang('laraflat::laraflat.Add Edit Remove Translation From') {{ $module->name }} .</p>
        </div>
        <!-- Default box -->
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-lg-2">
                        <h3>@lang('laraflat::laraflat.Keys')</h3>
                    </div>
            ...
            <div class="box-footer">
                ...
                <a href="{{ route('modules')}}" class="btn btn-warning"><i
                            class="fa fa-arrow-circle-left"></i> @lang('laraflat::laraflat.Modules')</a>
            </div>
            <!-- /.box-footer-->
            {!! Form::close() !!}
        </div>
