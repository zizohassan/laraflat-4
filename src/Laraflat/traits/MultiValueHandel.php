...
trait MultiValueHandel{
    ...
    {
        $data = "\t" . '/**' . "\n";
        $data .= "\t" . '* Get the  '.ucfirst(camel_case($column->name)) . "\n";
        $data .= "\t" . '*' . "\n";
        $data .= "\t" . '* @return string' . "\n";
        $data .= "\t" . '*/' . "\n\n";
        $data .= "\t" . 'public function get' . ucfirst(camel_case($column->name)) . 'ArrayAttribute()' . "\n";
        $data .= "\t" . '{' . "\n";
    ...
    protected function generateGetterForMultiColumnsValue($column)
    {
        ...
        $data .= "\t" . '* @return string' . "\n";
        $data .= "\t" . '*/' . "\n\n";
        $data .= "\t" . 'public function get' . ucfirst(camel_case($column->name)) . 'Attribute($value)' . "\n";
        $data .= "\t" . '{' . "\n";
    ...
    {
        $data = "\t" . '/**' . "\n";
        $data .= "\t" . '* Set the  '.ucfirst(camel_case($column->name)) . "\n";
        $data .= "\t" . '*' . "\n";
        $data .= "\t" . '* @param  string  $value' . "\n";
        $data .= "\t" . '* @return void' . "\n";
        $data .= "\t" . '*/' . "\n\n";
        $data .= "\t" . 'public function set' . ucfirst(camel_case($column->name)) . 'Attribute($value)' . "\n";
        $data .= "\t" . '{' . "\n";
